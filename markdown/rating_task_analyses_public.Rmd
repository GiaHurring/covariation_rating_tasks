...
scale_colour_discrete(labels = c("cons", "inn"))
...
exp1_binary_education_H1_H2 <- exp1_data_binary_final_education %>%
  ...
  guides(colour = guide_legend(title = "first vowel")) +
  scale_colour_discrete(labels = c("cons", "inn"))
...
Māori*, or who had *worse pronunciation* sounded *less educated* to me.
...
exp2_binary_gender_H1_H2 <- exp2_data_binary_final_gender %>%
  ...
  guides(colour = guide_legend(title = "first variable")) +
  scale_colour_discrete(labels = c("cons", "inn"))
